...
import { setVideoLoading, updateCompletedLectures } from '../../../slices/viewCourseSlice';
...
const VideoDetails = () => {
        ...
        const handleLectureCompletion = async () => {
            ...
            if (res) {
                ...
                const updatedCompletedLectures = [...completedLectures, subSectionId]
                console.log(updateCompletedLectures)
                localStorage.setItem("completedLectures", JSON.stringify(updatedCompletedLectures))
            }
